...
public enum StudentData {
    IVANOV_I("Ivanov Ivan", "Java Developer", LocalDateTime.of(2020, 6, 1, 10, 0), JAVA_DEVELOPER),
    SIDOROV_I("Sidorov Ivan", "J2EE Developer", LocalDateTime.of(2020, 6, 1, 10, 0), AQE);
